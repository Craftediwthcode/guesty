...
@section('content')
    <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
        <div class="flex-row text-center mx-auto">
            <img src="{{ URL::asset('assets/backend/img/pages/login-light.png') }}" alt="Auth Cover Bg color" width="520"
        ...
        <div class="w-px-400 mx-auto">
            <div class="app-brand mb-4">
                <a href="index.html" class="app-brand-link gap-2 mb-2">
                    ...
                    <span class="app-brand-text demo h3 mb-0 fw-bold">Guesty</span>
                </a>
            </div>
            <h4 class="mb-2">Welcome to Guesty! 👋</h4>
